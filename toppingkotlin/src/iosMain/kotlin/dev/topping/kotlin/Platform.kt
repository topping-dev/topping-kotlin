...
actual class Platform actual constructor() {
    actual companion object {
        private val bindingMap: HashMap<Any, Any> = hashMapOf(
            ...
            cocoapods.Topping.ILGRecyclerViewAdapter.className().toString() to ILGRecyclerViewAdapter::class,
            ...
            cocoapods.Topping.LGTextInputEditText.className().toString() to LGTextInputEditText::class,
