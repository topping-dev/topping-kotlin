...
actual open class LuaGraphics : KTInterface {
    ...
    actual fun drawImageRectCacheEx(
        i: String?,
        srcX: Int,
        srcY: Int,
        srcWidth: Int,
        ...
        luaGraphics?.drawImageRectCacheEx(
            i,
            srcX,
            srcY,
            srcWidth,
