        ...
        if (funcStore != null) {
            ...
            if (funcStoreL is Function0) {
                ...
                if (obj != null)
                    ...
                    ret = (funcStoreL as Function2<Any?, Any?, Any?>).invoke(
                        valsWrapped[0],
                        valsWrapped[1]
                    )
            } else if (funcStoreL is Function3<*, *, *, *>) {
                if (obj != null)
                    ret = (funcStoreL as Function3<Any?, Any?, Any?, Any?>).invoke(
                        obj,
                        valsWrapped[0],
                        valsWrapped[1]
                    )
                ...
                if (obj != null)
                    ret = (funcStoreL as Function4<Any?, Any?, Any?, Any?, Any?>).invoke(
                        obj,
                        valsWrapped[0],
                        valsWrapped[1],
                        valsWrapped[2]
                ...
                if (obj != null)
                    ret = (funcStoreL as Function5<Any?, Any?, Any?, Any?, Any?, Any?>).invoke(
                        obj,
                        valsWrapped[0],
                        valsWrapped[1],
                        valsWrapped[2],
                ...
                if (obj != null)
                    ret =
                        (funcStoreL as Function6<Any?, Any?, Any?, Any?, Any?, Any?, Any?>).invoke(
                            obj,
                            valsWrapped[0],
                            valsWrapped[1],
                            valsWrapped[2],
                ...
                if (obj != null)
                    ret =
                        (funcStoreL as Function7<Any?, Any?, Any?, Any?, Any?, Any?, Any?, Any?>).invoke(
                            obj,
                            valsWrapped[0],
                            valsWrapped[1],
                            valsWrapped[2],
                ...
                if (obj != null)
                    ret =
                        (funcStoreL as Function8<Any?, Any?, Any?, Any?, Any?, Any?, Any?, Any?, Any?>).invoke(
                            obj,
                            valsWrapped[0],
                            valsWrapped[1],
                            valsWrapped[2],
