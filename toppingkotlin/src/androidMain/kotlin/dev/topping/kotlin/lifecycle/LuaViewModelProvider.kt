...
actual open class LuaViewModelProvider : KTInterface {
    ...
    actual companion object {
        actual fun of(fragment: LuaFragment): LuaViewModelProvider {
            ...
            val nat =
                dev.topping.android.LuaViewModelProvider.ofFragment(fragment.GetNativeObject() as dev.topping.android.LuaFragment)
        ...
        actual fun of(form: LuaForm): LuaViewModelProvider {
            val prov = LuaViewModelProvider()
            val nat =
                dev.topping.android.LuaViewModelProvider.ofForm(form.GetNativeObject() as dev.topping.android.LuaForm)
            prov.SetNativeObject(nat)
            return prov
        }
    }
